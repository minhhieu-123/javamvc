            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Đặt hàng</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Đặt hàng</li>
                            <li class="breadcrumb-item active">Xóa đặt hàng</li>
                        </ol>
                        <div class="row">
                                 <p class="h1"> Xóa Order: ${id}</p>
                                <div class="card-body">
                                    <form:form method="POST" action="/admin/order/delete-order" modelAttribute="newOrder">
