...
<div class="container">
        <div class="row">
          <div class="d-flex" style="padding-top: 10px;">
            <h3>Productwith id = ${product_id}</h3>
          </div>
        ...
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">số luọng:${product.quantily}</li>
            <li class="list-group-item">Bán được:${product.shold}</li>
            <li class="list-group-item">Giảm giá:${product.discount}</li>
            <li class="list-group-item">Thuong hiêu:${product.brand.name}</li>
