...
<html lang="en">
 ...
 <div class="container">
        <div class="row">
            <p class="h1">Cập nhật người dùng</p>
            <form:form method="POST" action="/admin/user/updateuser" modelAttribute="newUsers">
                <div class="mb-3">
                    <label  class="form-label h2" for="">ID: ${newUsers.id}</label>
                    <form:input path="id" class="form-control" type="hidden" />
                </div>
                 <div class="mb-3">
                    <label  class="form-label h2" for="">Email: ${newUsers.email}</label>
                </div>
                 <div class="mb-3">
