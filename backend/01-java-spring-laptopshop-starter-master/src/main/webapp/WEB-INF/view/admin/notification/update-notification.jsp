          ...
          <script>
                   $(document).ready(() => {
                        const avatarFile = $("#avatarFile");
                           const orgImage = "${newNotification.image}"
                        if(orgImage){
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item active">Tạo mới thông báo</li>
                        </ol>
                        <div class="row">
                                <div class="card-body">
                                    <p class="h1">
                                    ...
                                    <form:form method="POST" action="/admin/notification/update-notification" modelAttribute="Notification" enctype="multipart/form-data">
                                         <c:set var="ErrorName">
                                            <form:errors path="name" cssClass="invalid-feedback" />
                                        </c:set>
                                        <div class="mb-3">
                                            <label  class="form-label h3" for="" >ID: ${newNotification.id}</label>
                                        ...
                                        <div class="mb-3">
                                         ...
                                         <div class="mb-3">
                                            ...
                                            <form:textarea class="form-control "  id="editor" path="detail_noti"></form:textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="formFile" class="form-label">Ảnh danh mục</label>
                                            <input class="form-control" type="file" id="avatarFile" accept=".png, .jpg, .jpeg" name="notificationFile"/>
                                        </div>
                                        <div class="mb-3">
