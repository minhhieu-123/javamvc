...
public class CategoryController {
    ...
    public String createCategoryPage(Model model, @ModelAttribute("newCategory") Categorys categorys, @RequestParam("categoryFile") MultipartFile file){
    ...
    @PostMapping("/admin/category/update-category")
     public String postUpdatePage(Model model, @ModelAttribute("newCategory") Categorys categorys){
